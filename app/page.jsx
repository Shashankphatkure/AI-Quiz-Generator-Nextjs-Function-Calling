  ...
  return (
    <div className="min-h-screen grid place-items-center">
      <div className="border rounded border-white/0 ">
        <h1 className="text-center text-3xl md:text-7xl font-bold bg-gradient-to-r from-emerald-500 via-pink-400 to-blue-500 bg-clip-text text-transparent q-animate-gradient">
          SkillQuiz
        </h1>
        <h4 className="text-center text-2xl md:text-2xl font-bold bg-gradient-to-r from-emerald-500 via-pink-400 to-blue-500 bg-clip-text text-transparent q-animate-gradient">
          Ai Quiz Generator
        </h4>
